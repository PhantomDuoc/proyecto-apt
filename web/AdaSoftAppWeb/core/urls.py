...
from .views import evento, index, logadm,login, quienes,registro, ubicacion,indexlog,quieneslog, ubicacionlog, eventolog,dashboard,estadistica,inventario,ventas
